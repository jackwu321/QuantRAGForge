...
def main(argv=None) -> int:
    ...
    ingest_source.register(sub.add_parser("ingest", help="Ingest articles (URL, URL-list, HTML, PDF file, PDF URL) into raw/."))
    ...
    verdicts_mod.register(sub.add_parser("verdict", help="实验判决层：外部回测/实验结论的写入与查询。"))
